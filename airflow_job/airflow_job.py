...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projetcs-gds1")
    bq_project = Variable.get("bq_project", default_var="fleet-codex-448412-i4")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "981798172346-compute@developer.gserviceaccount.com",
                "network_uri": "projects/fleet-codex-448412-i4/global/networks/default",
                "subnetwork_uri": "projects/fleet-codex-448412-i4/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="fleet-codex-448412-i4",
        region="us-central1",
